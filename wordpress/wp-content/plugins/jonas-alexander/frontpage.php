...
<!-- wp:html -->
<div class="page-content jumbotron" id="jonas">
    <div id="three-container"></div>
    <div class="my-short-info-grid">
        <div class="info-grid">
            <div class="my-picture-wrapper">
                <div class="image-container">
                    <img decoding="async" class="hover-image" src="/wp-content/uploads/jonas-1.jpg" alt="My Picture">
                </div>
            </div>
        </div>
...
<!-- wp:html -->
<div class="page-content about-me" id="ilovecoding">
...
<!-- <div class="page-content portfolio-projects-parallax">
    <h3 class="my-projects" style="color: var(--blueText);">Look at my portfolio projects:</h3>
    <div class="project-list-item" id="project-item-1">
        <div style="clear: both;width: 100%;gap: 40px;align-items: center;position: relative;display: flex;">
            <img style="flex: 1;max-width: 50%;" class="parallax-image" alt="Image 1"
                src="https://jonas-alexander.dk/wp-content/uploads/references/allingbjerggaard-1.jpg" />
            <div style="flex: 1;max-width: 50%;display: flex;gap: 10px;flex-direction: column;">
                <h4>Allingbjerggaard.dk - Responsive WooCommmerce webshop</h4>
                <p class="project-description">I developed the website for Allingbjerggaard, a charming farm shop located in Skibby.<br/>
                    The farm shop offers a selection of handmade Christmas decorations and hostess gifts, which can be purchased from their cozy roadside stall.</p>
                <p class="project-description">The website is designed with a focus on usability and aesthetics, giving visitors an easy and pleasant experience<br/>
...
<!-- <script>
    ...
    function parallaxEffect() {
        const projectItem1 = document.getElementById("project-item-1")
        const images = document.querySelectorAll('.parallax-image');

        images.forEach((img) => {
            // Calculate the distance from the element to the bottom of the viewport
            const distanceToBottomOfWindow = (projectItem1.getBoundingClientRect().top + window.scrollY) - (window.innerHeight / 2);

            const scrollAmount = window.scrollY - distanceToBottomOfWindow
            // const offset = img.getBoundingClientRect().top + scrollAmount;
            const offset = (window.scrollY - distanceToBottomOfWindow) - img.offsetTop;

            // Adjust the sliding speed (e.g., scroll 50% slower than page)
            const translateY = offset// * -0.5;
            console.log("translateY", translateY)

            // Apply transform to move the image slightly vertically
            if (translateY > 0 && window.innerHeight > translateY) img.style.marginTop = `${translateY}px`;
        });
    }
...
<div class="page-content portfolio-projects">
    ...
    <div class="projects-wrapper" style="clear: left;">
        <div class="projects-group">
            ...
            <div class="projects-group-grid">
                <div class="projects-group-item slide-fade-wrapper left">
                    <img class="parallax-image" alt="CasaNova - Property Listing Marketplace"
                ...
                <div class="projects-group-item slide-fade-wrapper left">
                    <img class="parallax-image" alt="GiveOrTake - Project Management & Time Tracking"
                ...
                <div class="projects-group-item slide-fade-wrapper left">
                    <img class="parallax-image" alt="YourSpace - Slack/Discord Clone"
        ...
        <div class="projects-group">
            ...
            <div class="projects-group-grid">
                <div class="projects-group-item slide-fade-wrapper right">
                    <img class=" parallax-image" alt="Funler Messaging"
        ...
        <div class="projects-group">
            ...
            <div class="projects-group-grid">
                <div class="projects-group-item slide-fade-wrapper left">
                    <img class="parallax-image" alt="Image 1"
                ...
                <div class="projects-group-item slide-fade-wrapper left">
                    <img class="parallax-image" alt="Go@Netto - REMA 1000 Vigo Webshop Clone"
...
<!-- wp:html -->
<div class="page-content cv-wrapper cv-contact-details" id="contactinfo">
    <div class="my-picture-and-contact-info">
        <div class="my-picture-wrapper-2">
            <img class="the-picture" src="/wp-content/uploads/jonas-2.jpg" alt="My picture" />
        </div>
        <div class="my-contact-info">
            <div>
                <p class="c30">
                    <span class="c37 c28 c34 c49">Jonas Alexander Sørensen</span><br />
                    <img style="width: 20px; height: 20px;" src="/wp-content/uploads/image3.png" alt="E-mail" /> <span
                        class="c23"> jonas.sorensen.93dk@gmail.com</span><br />
                    <img style="width: 20px; height: 20px;" src="/wp-content/uploads/image1.png" alt="Phone" /> <span
                        class="c36 c23"> +45 60 81 99 80</span>
                </p>
                <p class="c30">
                    <img style="width: 20px; height: 20px;" src="/wp-content/uploads/image2.png" alt="Age" /> <span
                        class="c23 c36"> 31 years old, 7 July 1993</span>
                </p>
                <p class="c30">
                    <img style="width: 20px; height: 20px;" src="/wp-content/uploads/image6.png" alt="City" /> <span
                        class="c23"> 2830 Virum<br /></span>
                    <img style="width: 20.11px; height: 21.50px;" src="/wp-content/uploads/image4.png" alt="Github" />
                    <span class="c23 c35"><a class="c3" href="https://github.com/J0nas7" target="_blank"
                            rel="noopener">Github.com/J0nas7</a><br /></span>
                </p>
                <div class="linkedIn">
                    <img style="width: 20.11px; height: 21.50px;" src="/wp-content/uploads/linkedin-icon.png"
                        alt="LinkedIn" />
                    <span class="c23 c35"><a class="c3"
                            href="https://www.linkedin.com/in/jonas-alexander-sørensen-92840495/" target="_blank"
                            rel="noopener">jonas-alexander-sørensen-92840495</a></span>
                </div>
            </div>
        </div>
    </div>
...
<!-- wp:html -->
<div class="page-content cv-wrapper working-experience" id="work">
...
<!-- wp:html -->
<div class="wp-block-group page-content cv-wrapper">
